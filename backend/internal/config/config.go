...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/useaidoanything-agent")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "useaidoanything-agent")
	...
	viper.SetDefault("database.user", "useaidoanything_agent")
	viper.SetDefault("database.password", "postgres")
	viper.SetDefault("database.dbname", "useaidoanything_agent")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "useaidoanything-agent:")
...
func GetServerAddress() string {
	...
	v.AddConfigPath("/etc/useaidoanything-agent")
