export default {
  ...
  nav: {
    ...
    affiliateAgentLevels: 'Agent Levels',
  ...
  admin: {
    ...
    affiliates: {
      levelsDescription: 'Configure progressive agent tiers and rebate rates',
      ...
      levels: {
        title: 'Agent Levels',
        description: 'Configure tier names, rebate rates, and automatic promotion thresholds.',
        add: 'Add Level',
        createTitle: 'Create Agent Level',
        editTitle: 'Edit Agent Level',
        level: 'Level',
        code: 'Code',
        name: 'Name',
        namePlaceholder: 'Bronze Agent',
        rate: 'Rebate Rate',
        threshold: 'Promotion Threshold',
        sortOrder: 'Rank',
        minInvitedLabel: 'Minimum Invited Users',
        minHistoryLabel: 'Minimum Historical Rebate',
        minInvited: '{count} invited users',
        minHistory: '${amount} historical rebate',
        enabled: 'Enabled',
        defaultLevel: 'Default fallback level',
        defaultBadge: 'Default',
        disable: 'Disable',
        disableTitle: 'Disable Agent Level',
        disableMessage: 'Disable "{name}"? Existing manual assignments to this level will be cleared.'
      }
    },
      ...
      features: {
        ...
        affiliate: {
          ...
          modal: {
            ...
            levelLabel: 'Manual Agent Level (optional)',
            levelAuto: 'Auto progression',
            levelHint: 'Leave empty to let the system pick the highest qualified enabled level.',
            errorBadRate: 'Please enter a number between 0 and 100',
            errorBadLevel: 'Please choose a valid agent level',
            errorEmpty: 'Fill at least one: custom invite code, exclusive rebate rate, or manual agent level',
          },
          batchModal: {
