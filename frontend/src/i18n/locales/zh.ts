export default {
  ...
  admin: {
    ...
    affiliates: {
      levelsDescription: '配置递进式代理等级和返佣比例',
      ...
      levels: {
        title: '代理等级',
        description: '配置代理等级名称、返佣比例，以及按邀请人数和历史返佣自动晋级的门槛。',
        add: '添加等级',
        createTitle: '创建代理等级',
        editTitle: '编辑代理等级',
        level: '等级',
        code: '等级编码',
        name: '等级名称',
        namePlaceholder: '青铜代理',
        rate: '返佣比例',
        threshold: '晋级门槛',
        sortOrder: '等级排序',
        minInvitedLabel: '最少邀请人数',
        minHistoryLabel: '最少历史返佣',
        minInvited: '邀请 {count} 人',
        minHistory: '历史返佣 ${amount}',
        enabled: '启用等级',
        defaultLevel: '默认兜底等级',
        defaultBadge: '默认',
        disable: '停用',
        disableTitle: '停用代理等级',
        disableMessage: '确定停用“{name}”吗？已有手动指定到该等级的用户会被清空等级，改为自动匹配。'
      }
    },
      ...
      features: {
        ...
        affiliate: {
          ...
          modal: {
            ...
            levelLabel: '手动代理等级（可选）',
            levelAuto: '按门槛自动晋级',
            levelHint: '留空则系统会按邀请人数和历史返佣匹配最高达标等级。',
            errorBadRate: '请输入 0-100 之间的比例',
            errorBadLevel: '请选择有效的代理等级',
            errorEmpty: '至少填写一项：专属邀请码、专属返利比例或手动代理等级',
          },
          batchModal: {
